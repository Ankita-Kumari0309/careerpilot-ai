...
const perks = ["AI resume analysis", "Free to start"];
        ...
        <Container maxWidth="xs" disableGutters>
          ...
          <Stack alignItems="center" mb={3} spacing={1.2} textAlign="center">
            ...
            <Typography sx={{ fontSize: "0.9rem", color: theme.palette.text.secondary }}>
              Join and boost your job hunt with AI.
            </Typography>
          </Stack>
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <PersonOutlineIcon sx={{ fontSize: 20, color: theme.palette.text.secondary }} />
                    </InputAdornment>
                  ),
                }}
              />
          ...
          <Stack direction="row" spacing={2} justifyContent="center" mt={2.5} flexWrap="wrap" useFlexGap>
            {perks.map((p) => (
              <Stack key={p} direction="row" spacing={0.5} alignItems="center">
                <CheckCircleIcon sx={{ fontSize: 15, color: theme.palette.primary.main }} />
                <Typography sx={{ fontSize: "0.78rem", color: theme.palette.text.secondary }}>{p}</Typography>
              </Stack>
            ))}
          </Stack>

          <Stack direction="row" spacing={0.7} justifyContent="center" mt={2.5}>
